...
> Current-state review, 2026-09-13: Original STS1 parity remains 86 enabled cards, 25 powers, 11 relics and six potions. Native additions include Another Mask, the Ancient reward models, and Ocean of Memories. There are 86 registered/library-visible cards; all nine STS1-disabled cards have no canonical native model. Current registration is 141 gameplay models. Inventory totals below measure original STS1 scope. All generated assets remain placeholders, not completed assets. See [current project state](CURRENT_STATE.md). This update supersedes conflicting current-state claims below; original records are retained as history.
